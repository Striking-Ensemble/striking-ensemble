          ...
          {this.props.currentPost.retailLinks.map((item, index) => {
            return (
              <div key={`boxAt${item.id}`} className="row list">
                <li key={item.id} className="col-lg-3 col-md-4 col-sm-6 col-xs-3">
    ...
    if (this.props.currentPost.video_low) {
      return (
        <div className="container-fluid">
          ...
          <br />
          <div className="row">
            <div id="post-item" className="col-lg-4 col-lg-offset-2 col-md-6 col-md-offset-1 col-sm-4 col-xs=12">
      ...
      return (
        <div className="container-fluid">
          ...
          <br />
          <div className="row">
            <div id="post-item" className="col-lg-4 col-lg-offset-2 col-md-4 col-md-offset-1 col-sm-8 col-xs=12">
